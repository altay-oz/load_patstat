...
Please take into account to use dos2unix or unix2dos to adjust the
file format to your used system. The last version is tested with for
the PATSTAT 2026 Spring version on Debian 13.
